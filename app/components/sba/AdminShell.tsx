...
import { BarChart3, Bell, BookOpen, CalendarDays, CalendarRange, GraduationCap, HandHeart, House, LayoutDashboard, Menu, Users, WalletCards, X } from "lucide-react";
...
const links = [
  ...
  ["Assistance", "/admin/assistance", HandHeart], ["Finance & salaries", "/admin/finance", WalletCards],
